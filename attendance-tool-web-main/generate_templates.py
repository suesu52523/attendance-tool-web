...
def create_abnormal_template():
    ...
    style_header(ws, headers)
    ws.append([
        1, '10010001', '张三', '底盘一组', '双班早班 2026-08-01 07:00:00~2026-08-01 15:45:00',
        '', '2026-08-01 16:56:29',
        '20260801', '20260801', '15:45', '18:45',
        3, 1, 2,
        '【加班结束卡】请确认加班结束时间'
    ])
...
def create_rectify_template():
    ...
    for group in GROUPS[:4]:
        ...
        style_header(ws, headers)
        ws.append([
            1, '10010001', '张三', group, '双班早班 2026-08-01 07:00:00~2026-08-01 15:45:00',
            '', '2026-08-01 16:56:29',
            '20260801', '20260801', '15:45', '18:45',
            3, 1, 2,
            '【加班结束卡】请确认加班结束时间',
...
def create_system_template():
    """系统数据模板：严格匹配 2007_ZPA_2007（校核）.xls 的 2007-加班申请 格式"""
    wb = Workbook()
    ws = wb.active
    ws.title = '2007-加班申请'
    headers = [
    ...
    style_header(ws, headers)
    ws.append([
        1, '10010001', '张三', '20260801', '20260801',
        '10 已核准的加班', '15:45', '18:45', 3, '1 支付加班费', '产能爬坡'
    ])
    ws.append([
        2, '10010002', '李四', '20260802', '20260802',
        '10 已核准的加班', '07:00', '15:45', 8, '1 支付加班费', '设备检修'
    ])
